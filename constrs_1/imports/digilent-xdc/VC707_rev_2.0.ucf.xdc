...
# set_property -dict { PACKAGE_PIN AT35 IOSTANDARD LVCMOS18 } [get_ports { HDMI_I2C_SCL }]; # I2C SCL (Main)
# set_property -dict { PACKAGE_PIN AU32 IOSTANDARD LVCMOS18 } [get_ports { HDMI_I2C_SDA }]; # I2C SDA (Main)
...
set_property -dict { PACKAGE_PIN AV30 IOSTANDARD LVCMOS18 } [get_ports { resetn_i }]; # DIP switch 0
# set_property -dict { PACKAGE_PIN AY33 IOSTANDARD LVCMOS18 } [get_ports { switchG }]; # DIP switch 1
# set_property -dict { PACKAGE_PIN BA31 IOSTANDARD LVCMOS18 } [get_ports { switchB }]; # DIP switch 2
...
# set_property -dict { PACKAGE_PIN AK34    IOSTANDARD LVDS } [get_ports { clk_in1 }]; #IO_L12P_T1_MRCC_35 Sch=gclk[100]
# create_clock -add -name sys_clk_pin -period 5.00 -waveform {0 2.5} [get_ports { clk_in1 }];
...
# set_property -dict { PACKAGE_PIN AJ32    IOSTANDARD LVCMOS18 } [get_ports { clk_in1 }]; #IO_L12P_T1_MRCC_35 Sch=gclk[100]
# create_clock -add -name sys_clk_pin -period 5.00 -waveform {0 2.5} [get_ports { clk_in1 }];
...
# set_property -dict { PACKAGE_PIN AM39 IOSTANDARD LVCMOS18 } [get_ports { READY }]; # LED 0
# set_property -dict { PACKAGE_PIN AN39 IOSTANDARD LVCMOS18 } [get_ports { adv7511_vs }]; # LED 1
...
# set_property PACKAGE_PIN AY42 [get_ports sw_enb_o]
# set_property IOSTANDARD LVCMOS18 [get_ports sw_enb_o]
...
# set_property -dict { PACKAGE_PIN AD38 IOSTANDARD LVCMOS18 } [get_ports { tx0 }];      # AD38  FMC2_HPC_LA06_P
# set_property -dict { PACKAGE_PIN AE38 IOSTANDARD LVCMOS18 } [get_ports { rx0 }];      # AE38  FMC2_HPC_LA06_N
...
# set_property -dict { PACKAGE_PIN AF42 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA05_P }];      # AF42  FMC2_HPC_LA05_P
# set_property -dict { PACKAGE_PIN AG42 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA05_N }];      # AG42  FMC2_HPC_LA05_N
...
# set_property -dict { PACKAGE_PIN V40 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA31_N }];  
######################################################################################################
...
############ FMC1_1 ####################
#########################################
set_property -dict { PACKAGE_PIN H40 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[6] }]; # FMC LA04_P
set_property -dict { PACKAGE_PIN H41 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[7] }]; # FMC LA04_N
# set_property -dict { PACKAGE_PIN H39 IOSTANDARD LVCMOS18 } [get_ports { spi0_clk }]; # FMC LA13_P
# set_property -dict { PACKAGE_PIN G39 IOSTANDARD LVCMOS18 } [get_ports { spi0_mosi }]; # FMC LA13_N
set_property -dict { PACKAGE_PIN G41 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[10] }]; # FMC LA07_P
set_property -dict { PACKAGE_PIN G42 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[11] }]; # FMC LA07_N
set_property -dict { PACKAGE_PIN F40 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[14] }]; # FMC LA11_P
set_property -dict { PACKAGE_PIN F41 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[15] }]; # FMC LA11_N
# set_property -dict { PACKAGE_PIN J40 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA01_CC_P }]; # FMC LA01_CC_P
# set_property -dict { PACKAGE_PIN J41 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA01_CC_N }]; # FMC LA01_CC_N
set_property -dict { PACKAGE_PIN K39 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[0] }]; # FMC LA00_CC_P
set_property -dict { PACKAGE_PIN K40 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[1] }]; # FMC LA00_CC_N
# set_property -dict { PACKAGE_PIN L39 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_CLK0_M2C_P }]; # FMC CLK0_M2C_P
# set_property -dict { PACKAGE_PIN L40 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_CLK0_M2C_N }]; # FMC CLK0_M2C_N
set_property -dict { PACKAGE_PIN M41 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_HS }]; # FMC LA05_P
set_property -dict { PACKAGE_PIN L41 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_VS }]; # FMC LA05_N
# set_property -dict { PACKAGE_PIN K42 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_CLK }]; # FMC LA06_P
# set_property -dict { PACKAGE_PIN J42 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_DE }]; # FMC LA06_N
set_property -dict { PACKAGE_PIN M42 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[4] }]; # FMC LA03_P
set_property -dict { PACKAGE_PIN L42 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[5] }]; # FMC LA03_N
# set_property -dict { PACKAGE_PIN K37 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA16_P }]; # FMC LA16_P
# set_property -dict { PACKAGE_PIN K38 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA16_N }]; # FMC LA16_N
# set_property -dict { PACKAGE_PIN M36 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA15_P }]; # FMC LA15_P
# set_property -dict { PACKAGE_PIN L37 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA15_N }]; # FMC LA15_N
set_property -dict { PACKAGE_PIN P41 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[2] }]; # FMC LA02_P
set_property -dict { PACKAGE_PIN N41 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[3] }]; # FMC LA02_N
set_property -dict { PACKAGE_PIN M37 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[8] }]; # FMC LA08_P
set_property -dict { PACKAGE_PIN M38 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[9] }]; # FMC LA08_N
# set_property -dict { PACKAGE_PIN R42 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA09_P }]; # FMC LA09_P
# set_property -dict { PACKAGE_PIN P42 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA09_N }]; # FMC LA09_N
set_property -dict { PACKAGE_PIN N38 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_DE }]; # FMC LA10_P
# set_property -dict { PACKAGE_PIN M39 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA10_N }]; # FMC LA10_N
set_property -dict { PACKAGE_PIN R40 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[12] }]; # FMC LA12_P
set_property -dict { PACKAGE_PIN P40 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[13] }]; # FMC LA12_N
# set_property -dict { PACKAGE_PIN N39 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA14_P }]; # FMC LA14_P
# set_property -dict { PACKAGE_PIN N40 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA14_N }]; # FMC LA14_N
...
# set_property -dict { PACKAGE_PIN AJ23 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_D11 }];
# set_property -dict { PACKAGE_PIN AK23 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_D10 }];
# set_property -dict { PACKAGE_PIN AK20 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_D9 }];
# set_property -dict { PACKAGE_PIN AL20 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_D8 }];
# set_property -dict { PACKAGE_PIN AJ22 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_D7 }];
# set_property -dict { PACKAGE_PIN AK22 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_D6 }];
# set_property -dict { PACKAGE_PIN AL21 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_D5 }];
# set_property -dict { PACKAGE_PIN AM21 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_D4 }];
# set_property -dict { PACKAGE_PIN AJ21 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_D3 }];
# set_property -dict { PACKAGE_PIN AJ20 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_D2 }];
# set_property -dict { PACKAGE_PIN AL22 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_D1 }];
# set_property -dict { PACKAGE_PIN AM22 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_D0 }];
# set_property -dict { PACKAGE_PIN AM24 IOSTANDARD LVCMOS18 } [get_ports { HDMI_INT }];
# set_property -dict { PACKAGE_PIN AN24 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_D17 }];
# set_property -dict { PACKAGE_PIN AM23 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_D16 }];
# set_property -dict { PACKAGE_PIN AN23 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_D15 }];
# set_property -dict { PACKAGE_PIN AP23 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_D14 }];
# set_property -dict { PACKAGE_PIN AP22 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_D13 }];
# set_property -dict { PACKAGE_PIN AN21 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_D12 }];
# set_property -dict { PACKAGE_PIN AP21 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_DE }];
# set_property -dict { PACKAGE_PIN AR23 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_SPDIF }];
# set_property -dict { PACKAGE_PIN AR22 IOSTANDARD LVCMOS18 } [get_ports { HDMI_SPDIF_OUT_LS }];
# set_property -dict { PACKAGE_PIN AT22 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_VSYNC }];
# set_property -dict { PACKAGE_PIN AU22 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_HSYNC }];
# set_property -dict { PACKAGE_PIN AU23 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_CLK }];
# set_property -dict { PACKAGE_PIN AV23 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_D35 }];
# set_property -dict { PACKAGE_PIN AW23 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_D34 }];
# set_property -dict { PACKAGE_PIN AW22 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_D33 }];
# set_property -dict { PACKAGE_PIN AT21 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_D32 }];
# set_property -dict { PACKAGE_PIN AU21 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_D31 }];
# set_property -dict { PACKAGE_PIN AR24 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_D30 }];
# set_property -dict { PACKAGE_PIN AT24 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_D29 }];
# set_property -dict { PACKAGE_PIN AV21 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_D28 }];
# set_property -dict { PACKAGE_PIN AW21 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_D27 }];
# set_property -dict { PACKAGE_PIN AU24 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_D26 }];
# set_property -dict { PACKAGE_PIN AV24 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_D25 }];
# set_property -dict { PACKAGE_PIN AY23 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_D24 }];
# set_property -dict { PACKAGE_PIN AY22 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_D23 }];
# set_property -dict { PACKAGE_PIN AY25 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_D22 }];
# set_property -dict { PACKAGE_PIN BA25 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_D21 }];
# set_property -dict { PACKAGE_PIN BA22 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_D20 }];
# set_property -dict { PACKAGE_PIN BB22 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_D19 }];
# set_property -dict { PACKAGE_PIN AY24 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_D18 }];

# --- ADV7511 HSYNC / VSYNC / CLK / DE ---
# set_property -dict { PACKAGE_PIN AU22 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_HS }];
# set_property -dict { PACKAGE_PIN AT22 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_VS }];
# set_property -dict { PACKAGE_PIN AU23 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_CLK }];
# set_property -dict { PACKAGE_PIN AP21 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_DE }];
# set_property -dict { PACKAGE_PIN AM24 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_INT }];
# set_property -dict { PACKAGE_PIN AR23 IOSTANDARD LVCMOS18 } [get_ports { HDMI_R_SPDIF }];
# set_property -dict { PACKAGE_PIN AR22 IOSTANDARD LVCMOS18 } [get_ports { HDMI_SPDIF_OUT_LS }];

# --- ADV7511 36-bit DATA BUS (R,G,B) ---
# set_property -dict { PACKAGE_PIN AM22 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[0] }];
# set_property -dict { PACKAGE_PIN AL22 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[1] }];
# set_property -dict { PACKAGE_PIN AJ20 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[2] }];
# set_property -dict { PACKAGE_PIN AJ21 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[3] }];
# set_property -dict { PACKAGE_PIN AM21 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[4] }];
# set_property -dict { PACKAGE_PIN AL21 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[5] }];
# set_property -dict { PACKAGE_PIN AK22 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[6] }];
# set_property -dict { PACKAGE_PIN AJ22 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[7] }];
# set_property -dict { PACKAGE_PIN AL20 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[8] }];
# set_property -dict { PACKAGE_PIN AK20 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[9] }];
# set_property -dict { PACKAGE_PIN AK23 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[10] }];
# set_property -dict { PACKAGE_PIN AJ23 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[11] }];
# set_property -dict { PACKAGE_PIN AN21 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[12] }];
# set_property -dict { PACKAGE_PIN AP22 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[13] }];
# set_property -dict { PACKAGE_PIN AP23 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[14] }];
# set_property -dict { PACKAGE_PIN AN23 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[15] }];
# set_property -dict { PACKAGE_PIN AM23 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[16] }];
# set_property -dict { PACKAGE_PIN AN24 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[17] }];
# set_property -dict { PACKAGE_PIN AY24 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[18] }];
# set_property -dict { PACKAGE_PIN BB22 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[19] }];
# set_property -dict { PACKAGE_PIN BA22 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[20] }];
# set_property -dict { PACKAGE_PIN BA25 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[21] }];
# set_property -dict { PACKAGE_PIN AY25 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[22] }];
# set_property -dict { PACKAGE_PIN AY22 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[23] }];
# set_property -dict { PACKAGE_PIN AY23 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D1[0] }];
# set_property -dict { PACKAGE_PIN AV24 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D1[1] }];
# set_property -dict { PACKAGE_PIN AU24 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D1[2] }];
# set_property -dict { PACKAGE_PIN AW21 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D1[3] }];
# set_property -dict { PACKAGE_PIN AV21 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D1[4] }];
# set_property -dict { PACKAGE_PIN AT24 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D1[5] }];
# set_property -dict { PACKAGE_PIN AR24 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D1[6] }];
# set_property -dict { PACKAGE_PIN AU21 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D1[7] }];
# set_property -dict { PACKAGE_PIN AT21 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D1[8] }];
# set_property -dict { PACKAGE_PIN AW22 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D1[9] }];
# set_property -dict { PACKAGE_PIN AW23 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D1[10] }];
# set_property -dict { PACKAGE_PIN AV23 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D1[11] }];
...
set_property -dict { PACKAGE_PIN J30 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[22] }];   # J30  FMC1_HPC_LA26_P
set_property -dict { PACKAGE_PIN H30 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[23] }];   # H30  FMC1_HPC_LA26_N

# set_property -dict { PACKAGE_PIN L29 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA28_P }];   # L29  FMC1_HPC_LA28_P
# set_property -dict { PACKAGE_PIN L30 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA28_N }];   # L30  FMC1_HPC_LA28_N

set_property -dict { PACKAGE_PIN J31 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[16] }];   # J31  FMC1_HPC_LA27_P
set_property -dict { PACKAGE_PIN H31 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[17] }];   # H31  FMC1_HPC_LA27_N
...
set_property -dict { PACKAGE_PIN L31 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[18] }]; # L31  FMC1_HPC_LA17_CC_P
set_property -dict { PACKAGE_PIN K32 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[19] }]; # K32  FMC1_HPC_LA17_CC_N

set_property -dict { PACKAGE_PIN N30 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_CLK }]; # N30  FMC1_HPC_CLK1_M2C_P
# set_property -dict { PACKAGE_PIN M31 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_CLK1_M2C_N }]; # M31  FMC1_HPC_CLK1_M2C_N

set_property -dict { PACKAGE_PIN P30 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[20] }];    # P30  FMC1_HPC_LA23_P
set_property -dict { PACKAGE_PIN N31 IOSTANDARD LVCMOS18 } [get_ports { HDMI_TX_D[21] }];    # N31  FMC1_HPC_LA23_N
...
# set_property -dict { PACKAGE_PIN N28 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA21_P }];    # N28  FMC1_HPC_LA21_P
# set_property -dict { PACKAGE_PIN N29 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA21_N }];    # N29  FMC1_HPC_LA21_N

# set_property -dict { PACKAGE_PIN R30 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA24_P }];    # R30  FMC1_HPC_LA24_P
# set_property -dict { PACKAGE_PIN P31 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA24_N }];    # P31  FMC1_HPC_LA24_N
...
# set_property -dict { PACKAGE_PIN V30 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA30_P }];    # V30  FMC1_HPC_LA30_P
...
# set_property -dict { PACKAGE_PIN W30 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA19_P }];    # W30  FMC1_HPC_LA19_P
# set_property -dict { PACKAGE_PIN W31 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA19_N }];    # W31  FMC1_HPC_LA19_N

# set_property -dict { PACKAGE_PIN V29 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA32_P }];    # V29  FMC1_HPC_LA32_P
...
set_property -dict { PACKAGE_PIN E19 IOSTANDARD LVDS } [get_ports clk_in_p];
set_property -dict { PACKAGE_PIN E18 IOSTANDARD LVDS } [get_ports clk_in_n];
